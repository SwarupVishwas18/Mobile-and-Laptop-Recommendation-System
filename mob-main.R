    ...
    mainPanel(
      ...
      mainPanel(
        tabsetPanel(type = "tabs",
                    ...
                    ,
                    tabPanel("ScatterPlot", plotOutput("plot", width = "400px")),
                    tabPanel("Box Plot", plotOutput("plot2", width = "400px")),
...
server <- function(input, output) {
  ...
  output$plot <- renderPlot(plot(phones$Rating, phones$Selling.Price, xlab = "Rating", ylab = "Selling Price", col=topo.colors(length(br))), res = 96)
  output$plot2 <- renderPlot(boxplot(phones$Original.Price, phones$Selling.Price, main="Boxplot of Orginal and Selling Price", 
                                     names=c("Rating", "Price"), col=c("orange","green")), res = 96)
  #output$plot3<- renderPlot(plot(phones$Rating, phones$Selling.Price, xlab = "Rating", ylab = "Selling Price"), res = 96)
